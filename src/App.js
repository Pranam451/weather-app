...
const mist = require("../src/assets/bg.jpg");
...
function App() {
  ...
  return (
    <>
      <div className="sm:block hidden text-center py-10">
        {" "}
        Please decrease display size 640px or switch to mobile devices
      </div>
              ...
              <div className="temp  flex  flex-col justify-center items-center my-7  ">
                ...
                <div className="flex">
                  ...
                  {weather.weather[0].main == "Rain" && (
                    <i
                      className={
                        "fa fa-cloud-rain text-5xl mt-1 px-2 text-white"
                      }
                    ></i>
                  )}
                  {weather.weather[0].main == "Haze" && (
                    <i
                      className={
                        "fa fa-cloud-fog text-5xl mt-1 px-2 text-white"
                      }
                    ></i>
                  )}
                  {weather.weather[0].main == "Mist" && (
                    <i
                      className={"fa fa-smoke text-5xl mt-1 px-2 text-white"}
                    ></i>
                  )}
                  {weather.weather[0].main == "Clear" && (
                    <i
                      className={
                        "fa fa-cloud-sun text-5xl mt-1 px-2 text-white"
                      }
                    ></i>
                  )}
